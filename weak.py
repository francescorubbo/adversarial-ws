...
_, __, X_val, y_val, X_test, y_test = getToys(means,stds,samplesize,scale=False)

X_train, y_train = getWeakToys(means,stds,samplesize,fractions)
...
if use_cuda:
    model.cuda()
from losses import MSELoss_LLP
#loss_fn = nn.MSELoss()
loss_fn = MSELoss_LLP()
